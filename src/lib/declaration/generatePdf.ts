...
export async function generateSelfDeclarationPdf(data: DeclarationData): Promise<Uint8Array> {
  ...
  const clauses = [
    ...
    "2. मैं किसी भी प्रकार का Chargeback, Fraud Transaction, Dispute, Unauthorized Transaction, Money Laundering, Gaming Transaction, Betting Transaction, Crypto Related Transaction, Foreign Remittance Misuse, Third Party Fund Misuse अथवा किसी भी प्रकार की अवैध, धोखाधड़ीपूर्ण (Fraudulent) या संदिग्ध वित्तीय गतिविधि में शामिल नहीं रहूँगा/रहूँगी।",
    "3. यदि मेरे अकाउंट (ID) पर किसी भी प्रकार का Chargeback आता है, तो मैं उसे सुलझाने (Resolve) में कंपनी का पूर्ण सहयोग करूँगा/करूँगी तथा आवश्यकता होने पर संबंधित राशि की वसूली (Recovery) में भी कंपनी की पूर्ण सहायता करूँगा/करूँगी।",
    `4. यदि मैं उक्त Chargeback को सुलझाने अथवा राशि की वसूली (Recovery) में सहयोग नहीं करता/करती हूँ, तो उस सम्पूर्ण राशि की जिम्मेदारी मेरी स्वयं की होगी तथा वह राशि मुझ (${onboardeeLabel}) से ही वसूल की जाएगी।`,
    "5. मैं KYC, नियमों एवं लागू कानूनों का पालन करूँगा/करूँगी तथा कंपनी द्वारा मांगे जाने पर आवश्यक दस्तावेज़, जानकारी एवं जांच में पूर्ण सहयोग दूँगा/दूँगी।",
    "6. मेरी किसी भी गतिविधि से कंपनी को होने वाले किसी भी वित्तीय नुकसान, चार्जबैक, पेनल्टी, कानूनी खर्च अथवा अन्य किसी भी प्रकार की हानि की भरपाई मैं स्वयं करूँगा/करूँगी।",
    "7. मैं स्वीकार करता/करती हूँ कि कंपनी केवल सेवा प्रदाता (Service Provider) है तथा मेरी गतिविधियों की अंतिम जिम्मेदारी मेरी स्वयं की है।",
    "8. यह घोषणा मेरी स्वेच्छा से, बिना किसी दबाव के दी जा रही है और यह कंपनी के साथ मेरे व्यावसायिक संबंधों का अभिन्न हिस्सा होगी।",
  ];
